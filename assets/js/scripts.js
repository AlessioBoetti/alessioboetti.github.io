const translations = {
    en: {
        ...
        'method-s2-tech1-desc': 'Computing statistics (mean, std, count, sum) over multiple temporal and grouped-based windows to capture behavior at different scales simultaneously.',
    ...
    it: {
        ...
        'method-s1-what': 'Uso statistiche descrittive, test e diagnostica visuale, come distribuzioni, correlazioni e decomposizioni, per individuare incoerenze, capire a fondo il problema e far emergere i punti critici prima di prendere qualsiasi altra decisione.',
        ...
        'method-s1-biz': 'Un\'analisi dati rigorosa previene l\'errore più costoso: <strong>costruire la soluzione giusta per il problema sbagliato</strong>. Capire distribuzioni, segmenti e bias prima della modellazione permette di intercettare segnali fuorvianti quando correggerli costa poco, non quando costa un intero deployment fallito in produzione perché il modello non funziona. Una fase esplorativa ben eseguita fa emergere insight cruciali: il segmento di dati problematico che in realtà è un artefatto proveniente dalla raccolta dati, il trend che è un <a href="https://en.wikipedia.org/wiki/Simpson%27s_paradox">paradosso di Simpson</a>, l\'outlier che rappresenta il gruppo di clienti di maggior valore. Poiché <strong>ogni informazione deriva da una catena visibile e verificabile</strong>, le decisioni superano le review invece di crollare al primo "Sei sicuro?".',
        ...
        'method-s2-p1': 'Il mio approccio alla feature engineering è guidato da ipotesi: parto dalla conoscenza di dominio per generare feature candidate, poi uso test statistici e criteri di importanza model-agnostic e model-based per filtrarle. Così evito di creare feature a caso che aumentano la complessità senza migliorare la qualità.',
        'method-s2-tech1-name': 'Aggregazioni su finestre mobili',
        'method-s2-tech1-desc': 'Calcolo di statistiche (media, deviazione standard, somma) su più finestre temporali e su più gruppi per catturare simultaneamente comportamenti su scale diverse.',
        ...
        'method-s2-tech3-desc': 'Uso della media dei valori assoluti SHAP come metrica principale di importanza, combinata con analisi di correlazione per rimuovere feature ridondanti preservando quelle complementari.',
